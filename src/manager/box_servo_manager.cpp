...
box::Servomanager::Servomanager(box::Servomotor* box_lower_servo,
    ...
    box::Servomanager::box_wait_till_servo_finished_moving = box_wait_till_servo_finished_moving;
...
void box::Servomanager::move_pilot_servo_to_percent(int percentage, int speed) {
    ...
    box_wait_till_servo_finished_moving->milliseconds(sleep_time_for_speed);
}
