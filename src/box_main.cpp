...
box::Main::Main() {
    box_wait_till_servo_finished_moving = new box::Wait();
    ...
    box_servo_manager = new box::Servomanager(box_lower_servo, box_upper_servo, box_wait_till_servo_finished_moving, box_switch);
