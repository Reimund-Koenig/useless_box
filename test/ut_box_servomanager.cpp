...
struct Servomanager_under_test : public box::Servomanager {
    Servomanager_under_test(box::Servomotor* box_lower_servo,
                    ...
                    : Servomanager(box_lower_servo, box_upper_servo,
                                    box_wait_till_servo_finished_moving, box_switch) {}
};
...
TEST_F(TestServomanager, test_servomanager_move_pilot_servo_percentage) {
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(100));
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(200));
...
TEST_F(TestServomanager, test_servomanager_move_copilot_servo_percentage) {
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(300));
    EXPECT_CALL(*box_lower_servo_mock, move_to_percent(_,_)).Times(0);
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(1000));
    EXPECT_CALL(*box_upper_servo_mock, move_to_percent(_,_)).Times(0);
...
TEST_F(TestServomanager, test_servomanager_move_both_servo_percentage) {
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(1400));
    EXPECT_CALL(*box_upper_servo_mock, move_to_percent(expected_result_copilot,5)).WillOnce(Return(2000));
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(2000));
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(1));
    EXPECT_CALL(*box_lower_servo_mock, move_to_percent(expected_result_copilot,2)).WillOnce(Return(2));
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(2));
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(42));
    ...
    EXPECT_CALL(*box_wait_till_servo_finished_moving, milliseconds(555));
